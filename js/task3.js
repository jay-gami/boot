...
sum++;
  ...
  var table=`<tr><td id="roll">${sum}</td><td><input type="text" id="txtname" onchange="add()"></td><td><input type="number" id="txtmaths" onchange="add()" ></td><td><input type="number" id="txtenglish" onchange="add()" ></td><td><input type="number" id="txtscience" onchange="add()"></td><td id="total"></td><td id="percentage"></td></tr>`
