...
sum++;
  ...
  var table=`<tr><td id="roll">${sum}</td><td><input type="text" id="txtname" ></td><td><input type="number" id="txtmaths" onchange="AddNewData()" ></td><td><input type="number" id="txtenglish" onchange="AddNewData()" ></td><td><input type="number" id="txtscience" onchange="AddNewData()"></td><td id="total"></td>
